package com.db.datasharding.dbConfig;
...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        ShardingRule shardingRule = ShardingRule.builder()
                ...
                .databaseShardingStrategy(new DatabaseShardingStrategy("phone", databaseShardingAlgorithm))
                .tableShardingStrategy(new TableShardingStrategy("phone", tableShardingAlgorithm)).build();
